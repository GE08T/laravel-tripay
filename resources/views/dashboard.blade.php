        ...
        <tbody>
            <tr class="bg-white border-b ">
                ...
                <th scope="row" class="flex items-center py-4 px-6 text-gray-900 whitespace-nowrap">
                    <img class="w-10 h-10 rounded-full" src="{{ "https://randomuser.me/photos".100.$transaction->id }}" alt="Jese image">
                    <div class="pl-3">
                ...
                <td class="py-4 px-6">
                    ...
                    <span class="bg-green-100 text-green-800 text-sm font-semibold uppercase mr-2 px-2.5 py-0.5 rounded-xl">{{ $transaction->status }}</span>
                    @else
                    <span class="bg-red-100 text-red-800 text-sm font-semibold uppercase mr-2 px-2.5 py-0.5 rounded-xl">{{ $transaction->status }}</span>
                    @endif
                </td>   
                @endforeach
